...
{
    public class NUnitTemplate : ITestTemplate
    {
        public string GetTestAttributeName() => "[Test]";
        public string GetTestClassAttributeName() => "[TestFixture]";
        public string GetSetupAttributeName() => "[SetUp]";
        public string GetTeardownAttributeName() => "[TearDown]";
        ...
        public string GenerateTestClass(ClassAnalysis classAnalysis, GenerationOptions options)
        {
            ...
            // Fields for mocks and system under test
            ...
            sb.AppendLine("        {");
            sb.AppendLine("            // Initialize mocks and system under test");
        ...
        public string GenerateTestMethod(MethodAnalysis methodAnalysis, string testCaseName, GenerationOptions options)
        {
            ...
            {
                sb.AppendLine("            Assert.Pass(\"TODO: Implement test assertions\");");
            }
